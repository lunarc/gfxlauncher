...
if __name__ == '__main__':
    ...
    parser.add_argument("--simplified", dest="simplified", action="store_true", default=True)
    ...
    parser.add_argument("--name", dest="job_name", action="store", default="lhpc", help="Job name in LRMS.")
